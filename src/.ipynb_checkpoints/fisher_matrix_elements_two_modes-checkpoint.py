...
def ft_dh_dA_real(parameter:dict):
    ...
    return R*(tau_1*np.exp(-1j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1) + tau_1*np.exp(1j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1))/2 + tau_0*np.exp(-1j*phi_0)/(2*(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)) + tau_0*np.exp(1j*phi_0)/(2*(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1))
...
def ft_dh_dA_imag(parameter:dict):
    ...
    return 0.5j*(R*(-tau_1*np.exp(-1j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1) + tau_1*np.exp(1j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)) - tau_0*np.exp(-1j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1) + tau_0*np.exp(1j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1))
...
def ft_dh_dphi0_real(parameter:dict):
    ...
    return A*(-1j*tau_0*np.exp(-1j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1) + 1j*tau_0*np.exp(1j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1))/2
...
def ft_dh_dphi0_imag(parameter:dict):
    ...
    return 0.5j*A*(1.0j*tau_0*np.exp(-1.0j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1) + 1.0j*tau_0*np.exp(1.0j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1))
...
def ft_dh_df0_real(parameter:dict):
    ...
    return A*(4*np.pi*tau_0**3*(-2*np.pi*f_0 + 2*np.pi*freq_array)*np.exp(1.0j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)**2 - 4*np.pi*tau_0**3*(2*np.pi*f_0 + 2*np.pi*freq_array)*np.exp(-1.0j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)**2)/2
...
def ft_dh_df0_imag(parameter:dict):
    ...
    return 0.5j*A*(4*np.pi*tau_0**3*(-2*np.pi*f_0 + 2*np.pi*freq_array)*np.exp(1.0j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)**2 + 4*np.pi*tau_0**3*(2*np.pi*f_0 + 2*np.pi*freq_array)*np.exp(-1.0j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)**2)
...
def ft_dh_dtau0_real(parameter:dict):
    ...
    return A*(-2*tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2*np.exp(1.0j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)**2 - 2*tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2*np.exp(-1.0j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)**2 + np.exp(-1.0j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1) + np.exp(1.0j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1))/2
...
def ft_dh_dtau0_imag(parameter:dict):
    ...
    return 0.5j*A*(-2*tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2*np.exp(1.0j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)**2 + 2*tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2*np.exp(-1.0j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1)**2 - np.exp(-1.0j*phi_0)/(tau_0**2*(2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1) + np.exp(1.0j*phi_0)/(tau_0**2*(-2*np.pi*f_0 + 2*np.pi*freq_array)**2 + 1))
...
def ft_dh_dR_real(parameter:dict):
    ...
    return A*(tau_1*np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1) + tau_1*np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1))/2
...
def ft_dh_dR_imag(parameter:dict):
    ...
    return 0.5j*A*(-tau_1*np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1) + tau_1*np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1))
...
def ft_dh_dphi1_real(parameter:dict):
    ...
    return A*R*(-1.0j*tau_1*np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1) + 1.0j*tau_1*np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1))/2
...
def ft_dh_dphi1_imag(parameter:dict):
    ...
    return 0.5j*A*R*(1.0j*tau_1*np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1) + 1.0j*tau_1*np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1))
...
def ft_dh_df1_real(parameter:dict):
    ...
    return A*R*(4*np.pi*tau_1**3*(-2*np.pi*f_1 + 2*np.pi*freq_array)*np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)**2 - 4*np.pi*tau_1**3*(2*np.pi*f_1 + 2*np.pi*freq_array)*np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)**2)/2
...
def ft_dh_df1_imag(parameter:dict):
    ...
    return 0.5j*A*R*(4*np.pi*tau_1**3*(-2*np.pi*f_1 + 2*np.pi*freq_array)*np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)**2 + 4*np.pi*tau_1**3*(2*np.pi*f_1 + 2*np.pi*freq_array)*np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)**2)
...
def ft_dh_dtau1_real(parameter:dict):
    ...
    return A*R*(-2*tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2*np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)**2 - 2*tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2*np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)**2 + np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1) + np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1))/2
...
def ft_dh_dtau1_imag(parameter:dict):
    ...
    return 0.5j*A*R*(-2*tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2*np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)**2 + 2*tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2*np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1)**2 - np.exp(-1.0j*phi_1)/(tau_1**2*(2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1) + np.exp(1.0j*phi_1)/(tau_1**2*(-2*np.pi*f_1 + 2*np.pi*freq_array)**2 + 1))
